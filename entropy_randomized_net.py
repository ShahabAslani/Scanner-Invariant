...
filepath = "/home/shas/projects/rrg-hamarneh/sponsored/shas/model6/weights-improvement-{epoch:02d}.hdf5"
...
training_generator = generator2(h5path='/dev/shm/shas/SFU_scaled', indices=index_tr, batchSize=15, imagesize=64,
                                channel=4, number_class=56, is_train=True)
validation_generator = generator2(h5path='/dev/shm/shas/SFU_scaled', indices=index_va, batchSize=15, imagesize=64,
                                  channel=4, number_class=56, is_train=False)
